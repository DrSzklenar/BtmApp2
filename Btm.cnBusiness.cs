...
namespace Business
{
    ...
    public partial class cnBusiness : DbContext
    {
        ...
        private void CustomerMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>().Property(x => x.customerId).HasColumnName(@"customerId").ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity<Customer>().HasIndex(@"customerId").IsUnique(true);
        }
        ...
        private void ProductMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().Property(x => x.productId).HasColumnName(@"productId").IsRequired().ValueGeneratedOnAdd();
        ...
        private void TransactionMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Transaction>().Property(x => x.transactionId).HasColumnName(@"transactionId").IsRequired().ValueGeneratedOnAdd();
        ...
        private void TransactionItemMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TransactionItem>().Property(x => x.transactionItemId).HasColumnName(@"transactionItemId").IsRequired().ValueGeneratedOnAdd();
